package com.esprit.todoapp.Fragments;
...
public class FragmentTodoList extends Fragment {
            ...
            public void moreItemClick(View view, Object item, int position, MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_delete:
                        ...
                        Toast.makeText(getActivity(), getString(R.string.todoListDeleteMessage),Toast.LENGTH_SHORT);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.todoListPageTitle, user.getUserName()));
    ...
    private void deleteSelectedListItems() {
        ...
        Toast.makeText(getActivity(), getString(R.string.todoListDeleteMessage),Toast.LENGTH_SHORT).show();
        getTodoLists();
    }
